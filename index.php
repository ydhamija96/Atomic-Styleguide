...
<?php else: ?>
    <body id="atomic-styleguide-body">
        <div class="atomicstyleguidedefaults">
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li id="atomic-styleguide-search-button" style="cursor:pointer;"><i class="fa fa-search fa-fw"></i></li>
        ...
        <div id="content" class="demo_class">
            <?php if(isset($_GET['search'])): ?>
                ...
                ?>
                <div class="atomicstyleguidedefaults singleElement">
                    <h4>Closest things to '<?=$search?>' we could find:</h4>
                </div>
                <?php
                    function cmp($a, $b){
                        if($a == $b){
                ...
                <?php
                    if(!$singleFile){   // If the URL does not specify a single file in the repo
                        ...
                        elseif($repo->pwd() == '/'){   // If at document root.
                            ?>
                                <div class="atomicstyleguidedefaults" id="homeContent">
                                    <h2>Welcome...</h2>
